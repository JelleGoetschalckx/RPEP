...
def LeeCode(part_numb, info):
    ...
    #     suffix = 1
    #     while True:
    file_path = os.path.join(directory_to_write_to, f"EJ_RPEP_Subject_{part_numb}_Data.csv")
    ...
    posList = [
        ...
        norm_to_pix_pos((0.45, 0.35)),  # 2 uur, shape 2
        norm_to_pix_pos((0.45, -0.35)),  # 4 uur, shape 3
        norm_to_pix_pos((0.0, -0.75)),  # 6 uur, shape 4
        norm_to_pix_pos((-0.45, -0.35)),  # 8 uur, shape 5
        norm_to_pix_pos((-0.45, 0.35))  # 10 uur, shape 6
    ]
